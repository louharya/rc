        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link" href="/home"><i class="fa fa-history" aria-hidden="true"></i>
                            History</a>
                    </li> --}}
                    {{-- <li class="nav-item">
                            <a class="nav-link" href="#"><i class="fa fa-calendar" aria-hidden="true"></i>
                                Order</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('items.index') }}"><i class="fa fa-car"
